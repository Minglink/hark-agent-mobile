...
/**
 * [T-android-minis-url-double-encoding] Decode candidates for a `hark://`
 * path.
 *
 * The field report: `hark://workspace/厚升凭证拆分/厚博-2026-03-935.pdf` was
 ...
 * to `ChatLinkAction.Web`, and a web preview of a `hark://` URL renders
