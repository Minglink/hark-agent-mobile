...
val LightChatPalette = ChatPalette(
    ...
    inputBg = Color.White,
    inputIconBg = Color(0xFFEFF6FF),
    inputIconBorder = Color(0xFFDBEAFE),
    inputBorder = Color(0xFFBFDBFE),
    ...
    toolBg = Color.White,
    toolBorder = Color(0xFFDBEAFE),
    toolCapsuleBg = Color(0xFFEFF6FF),
    separator = Color(0xFFD6E4FF),
    sendButton = Color(0xFF2563EB),
    sendButtonDisabled = Color(0xFFCBD5E1),
    codeBlockBg = Color(0xFFF8FAFF),
    codeBlockText = Color(0xFF1E3A8A),
    inlineCodeBg = Color(0xFFEFF6FF),
    inlineCodeText = Color(0xFF1D4ED8),
    link = Color(0xFF2563EB),
    blockquoteBar = Color(0xFF2563EB),
    thinking = Color(0xFF2563EB),
    warningBg = Color(0xFFFEF3C7),
    warningText = Color(0xFF92400E),
    tableBorder = Color(0xFFD6E4FF),
    inputShadow = Color(0x142563EB),
    toastBg = Color(0x1A2563EB),
    thumbnailBorder = Color(0xFFBFDBFE),
    sheetHeaderBg = Color.White,
    sheetHeaderBorder = Color(0xFFD6E4FF),
