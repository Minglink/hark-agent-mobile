...
/**
 * ZIP packaging for `.harkbak`, on both sides of the wire.
 *
...
object BackupZip {
     ...
     * `harkbak-<uuid>/manifest.json` rather than bare `manifest.json`.
     */
     ...
     *
     * After extraction the real package root may be `<dest>/harkbak-<uuid>/`
