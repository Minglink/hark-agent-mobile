...
object ReadImageTool {
    ...
    fun definition(): AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            ...
            "path" to AgentToolParam("string", "Linux path (e.g. /var/hark/attachments/chart.png) or hark:// URL (e.g. hark://attachments/chart.png)"),
     ...
     * (`/var/hark/{attachments,workspace,offloads,browser}/...`) resolve
    ...
    fun execute(argsJson: String, sessionId: String? = null, context: Context? = null): ToolExecutionResult {
        return try {
            ...
            val path = if (rawPath.startsWith("hark://")) {
