 ...
 *
 * Linux-visible mount: `/var/hark/offloads/tools/<file>`. The host base
 * `filesDir/hark-sessions/<sid>/offloads` is bind-mounted into the
...
object ContextOffload {
    ...
    const val LINUX_OFFLOADS_DIR = "/var/hark/offloads"
    ...
    fun toolsDir(context: Context, sessionId: String): File =
        File(context.filesDir, "hark-sessions/$sessionId/offloads/tools")
